...
<div style="max-width:400px;margin:0 auto">
    ...
    <div id="receipt-data">
        <div class="centered">
            ...
            <h1 style="font-size: 18px;">{{$lims_biller_data->company_name}}</h1>
            
            <p style="margin: 0px">{{trans('file.Address')}}: {{$lims_warehouse_data->address}}
        ...
        <table>
            ...
            <tfoot>
                ...
                <tr>
                    ...
                    <th style="text-align:right">{{number_format((float)($lims_sale_data->sale_note), 2, '.', '')}}</th>
                </tr>

                <tr>
                    <th colspan="2">{{trans('file.grand total')}}</th>
                    <th style="text-align:right">{{number_format(((float)($lims_sale_data->grand_total)+(float)$lims_sale_data->sale_note), 2, '.', '')}}</th>
                </tr>
        ...
        <table>
            <tbody>
                ...
                @endforeach -->
                <tr><td class="centered" colspan="3">{{trans('file.Thank you for shopping with us. Please come again')}}
