                ...
                <div class="card">
                    ...
                    <div class="payment-options">
                        ...
                        <div class="column-5" style="min-width: 50%">
                            <button style="background: #213170; width: 100%" type="button" class="btn btn-custom payment-btn" data-toggle="modal" data-target="#add-payment" id="cash-btn"><i class="fa fa-money"></i> Cash Payment </button>
                        </div>
                       <!--  <div class="column-5">
...
<?php echo $__env->make('layout.top-head', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\xampp\htdocs\jposv2\resources\views/sale/pos.blade.php ENDPATH**/ ?>