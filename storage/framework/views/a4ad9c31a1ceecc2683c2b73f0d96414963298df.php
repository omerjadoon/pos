...
<section class="forms">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <div class="row mt-5">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <?php const HTML_DATETIME_LOCAL = 'Y-m-d\TH:i'; //escape the literal T so it is not expanded to a timezone code
                                         $php_timestamp = strtotime(($lims_purchase_data->created_at));
 ...
 ?>
                                            ...
                                            <input type="datetime-local" name="created_at" class="form-control" value="<?php echo e($html_datetime_string); ?>" step="any" />
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="form-group">
...
<?php echo $__env->make('layout.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\xampp\htdocs\jposv3automobile\resources\views/purchase/edit.blade.php ENDPATH**/ ?>