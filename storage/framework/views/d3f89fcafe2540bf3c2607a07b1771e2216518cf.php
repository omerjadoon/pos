			...
			<div class="col-md-4">
				<div class="colored-box">
					...
					<div class="mt-3">
						...
						<p class="mt-2"><?php echo e(trans('file.profit')); ?> <span class="float-right"> <?php echo e(number_format((float)($sale[0]->grand_total - $sale[0]->grand_cost), 2, '.', '')); ?></span></p>
					</div>
				</div>
			</div>
			<div class="col-md-4">
...
<?php echo $__env->make('layout.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\xampp\htdocs\jposv3automobile\resources\views/report/profit_loss.blade.php ENDPATH**/ ?>