              ...
              <ul class="nav-menu list-unstyled d-flex flex-md-row align-items-md-center">
                ...
                <li class="nav-item">
                      ...
                      <ul class="dropdown-menu edit-options dropdown-menu-right dropdown-default" user="menu">
                          ...
                          <li>
                            <a href="<?php echo e(url('language_switch/ur')); ?>" class="btn btn-link"> Urdu - اردو</a>
                          </li>
                          <!-- <li>
...
</html><?php /**PATH E:\xampp\htdocs\jposv3automobile\resources\views/layout/main.blade.php ENDPATH**/ ?>