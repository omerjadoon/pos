...
<section class="forms pos-section">
    <div class="container-fluid">
        <div class="row">
            ...
            <div class="col-md-6">
                <div class="card">
                    ...
                    <div class="payment-options">
                        ...
                        <div class="column-5" style="min-width: 50%">
                            <button style="background-color: #5f27cd" type="button" class="btn btn-custom payment-btn" data-toggle="modal" data-target="#add-payment" id="cash-btn"><i class="fa fa-money"></i> Cash Payment </button>
                        </div>
                        <!--  <div class="column-5" >
                            <button  type="button" style="background: #213170; width: 100%" class="btn btn-custom labour-btn" data-toggle="modal" data-target="#order-labour" id="labour-btn"><i class="fa fa-money"></i> Labour </button>
                        </div> -->
                       <!--  <div class="column-5">
                       ...
                       <!--  <div class="column-5">
                        ...
                        <div class="column-5">
                            <button style="background-color: #b33771;" type="button" class="btn btn-custom" data-toggle="modal" data-target="#recentTransaction"><i class="dripicons-clock"></i> Recent transaction</button>
                        </div>
                    </div>
                </div>
            </div>
                                ...
                                <div class="col-md-10">
                                    ...
                                    <div class="row">
                                       <div class="col-md-6 form-group">
                                            ...
                                            <input type="number" value="0" class="form-control" name="sale_note"/>
                                        </div>
                                        <div class="col-md-6 form-group">
            ...
            <!-- order_labour modal -->
            <div id="order-labour" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true" class="modal fade text-left">
                <div role="document" class="modal-dialog">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h5 class="modal-title">Labour Cost</h5>
                            <button type="button" data-dismiss="modal" aria-label="Close" class="close"><span aria-hidden="true"><i class="dripicons-cross"></i></span></button>
                        </div>
                        <div class="modal-body">
                            <div class="form-group">
                                <input type="text" name="labour_cost" class="form-control numkey">
                            </div>
                            <button type="button" name="order_labour_cost_btn" class="btn btn-primary" data-dismiss="modal"><?php echo e(trans('file.submit')); ?></button>
                        </div>
                    </div>
                </div>
            </div>
                            ...
                            <?php for($i=0; $i < ceil($product_number/5); $i++): ?>
                                <tr>
                                    <td class="product-img sound-btn" title="<?php echo e($lims_product_list[0+$i*5]->name); ?>" data-product ="<?php echo e($lims_product_list[0+$i*5]->code . ' (' . $lims_product_list[0+$i*5]->name . ')'); ?>"><img  src="<?php echo e(url('public/images/product',$lims_product_list[0+$i*5]->base_image)); ?>" width="100%" />
                                        ...
                                        <?php echo e($lims_product_list[0+$i*5]->code); ?>
...
function addNewProduct(data){
    ...
    cols += '<td class="col-sm-4 product-title"><button type="button" class="edit-product btn btn-link" data-toggle="modal" data-target="#editModal"><strong>' + data[0] + '</strong></button>'+ data[12] + '<p>In Stock: <span class="in-stock"></span></p></td>';
...
<?php echo $__env->make('layout.top-head', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\xampp\htdocs\jposv3automobile\resources\views/sale/pos.blade.php ENDPATH**/ ?>