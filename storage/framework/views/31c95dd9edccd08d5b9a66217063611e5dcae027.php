...
<div style="max-width:400px;margin:0 auto">
    ...
    <div id="receipt-data">
        <div class="centered">
            ...
            <h1 style="font-size: 18px;"><?php echo e($lims_biller_data->company_name); ?></h1>
            
            <p style="margin: 0px"><?php echo e(trans('file.Address')); ?>: <?php echo e($lims_warehouse_data->address); ?>
        ...
        <table>
            ...
            <tfoot>
                ...
                <?php endif; ?>
                <tr>
                     <th colspan="2">Labour Cost</th>
                    <th style="text-align:right"><?php echo e(number_format((float)($lims_sale_data->sale_note), 2, '.', '')); ?></th>
                </tr>

                <tr>
                    <th colspan="2"><?php echo e(trans('file.grand total')); ?></th>
                    <th style="text-align:right"><?php echo e(number_format(((float)($lims_sale_data->grand_total)+(float)$lims_sale_data->sale_note), 2, '.', '')); ?></th>
                </tr>
        ...
        <table>
            <tbody>
                ...
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?> -->
                <tr><td class="centered" colspan="3"><?php echo e(trans('file.Thank you for shopping with us. Please come again')); ?>
...
<?php /**PATH E:\xampp\htdocs\jposv3automobile\resources\views/sale/invoice.blade.php ENDPATH**/ ?>