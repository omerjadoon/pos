		...
		<div class='wrapper'>
		    ...
		    <div class="content">
		        ...
		        <form  action="step4.php" method="post">
		            <fieldset>
						<label>JPOS Licence Code <a href="#purchasecodeModal" role="button" data-toggle="modal">?</a></label>
		                <input type='text' class="form-control" name="purchasecode">
		                <label>Database Host (<span class='help-block'>e.g. localhost</span>)</label>
		                <input type='text' value="localhost" class="form-control" name="dbhost">
		                <label>Database Username</label>
		                <input type='text' value="root" class="form-control" name="dbuser">
		                <label>Database Password</label>
		                <input type='password' value="" class="form-control" name="dbpass">
		                <label>Database Name</label>
		                <input type='text' class="form-control" value="posdb" name="dbname">
	  ...
	  <div class="modal-dialog" role="document">
	    <div class="modal-content">
	      ...
	      <div class="modal-body">
	        <p>A Unique code was provided to you by Jadoon Technologies Team. Please enter that Licence code or contact 03359119460 for further assistance. Thanks</p>
	      </div>
	    </div>
	  </div>
	</div>
